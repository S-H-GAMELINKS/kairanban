...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { auther: @notice.auther, content: @notice.content, greet: @notice.greet, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { auther: @notice.auther, content: @notice.content, greet: @notice.greet, title: @notice.title } }
